...
.then(response => {
  ...
  if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
    ...
    return api.sendMessage("চলে এসেছি আমি পিচ্চি ফাহিম এর 𝗕𝗢𝗧 তোমাদের মাঝে🤭!", event.threadID, () => api.sendMessage({ body: `${global.config.BOTNAME} CONNECTED«\n\nAssalamualaykum☘️
<------------------------------>  
...
DEVELOPER :𝗙𝗔𝗛𝗜𝗠 𝗔𝗛𝗠𝗘𝗗 

🟣Facebook Account Link: 

https://www.facebook.com/hackar.vaiya

🔵WHATSAPP NUMBER: wa.me/+8801771240377

🟢SUPPORT EMAIL: fahimvaiya91@gmail.com`, attachment: fs.createReadStream(gifPath)}, threadID));
  }})
.catch(error => {
    console.error(error);
});
    ...
    try {
      ...
      for (let o = 0; o < event.logMessageData.addedParticipants.length; o++) {
        ...
        var ok = [
          'https://i.imgur.com/u5WPb1q.mp4',
          'https://i.imgur.com/XcSE5Vj.mp4',
          'https://i.imgur.com/MEGpuIm.mp4',
          'https://i.imgur.com/0frNz8C.jpeg',
          'https://i.imgur.com/EY7l8H3.jpeg'
        ]
